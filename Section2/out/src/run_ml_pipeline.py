...
if __name__ == "__main__":
    ...
    split['train_tmp'], split['test'] = train_test_split(keys, test_size=0.20, random_state=0)
    split['train'], split['val'] = train_test_split(split['train_tmp'], test_size=0.20, random_state=0)
