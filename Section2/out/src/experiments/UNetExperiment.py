...
class UNetExperiment:
    ...
    def train(self):
        ...
        print(f"Number of slices: {len(self.train_loader)}")
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: The batch index, the predicted label, and shape of the predicted label: Y,Z
            #
    ...
    def run_test(self):
        ...
        for i, x in enumerate(self.test_data):
            ...
            sensitivity2 = Sensitivity(x['seg'], pred_label)
            specificity2 = Specificity(x['seg'], pred_label)
